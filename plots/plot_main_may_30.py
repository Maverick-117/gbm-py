...
Doses = [2,1]; n = 1;
C = [0, 0.005196];
deathFdbkQ = False; kimDeathValQ = True; kimReprogQ = False;
date_dir = '3_June\\'
if kimDeathValQ:
...
data_drty = "C:\\Users\\jhvo9\\Google Drive (vojh1@uci.edu)\\a PhD Projects\\GBM Modeling\\python scripts\\data\\kim_model\\"+date_dir+ deathVal_dir + sub_drty
plot_drty = "C:\\Users\\jhvo9\\Google Drive (vojh1@uci.edu)\\a PhD Projects\\GBM Modeling\\python scripts\\plots\\kim_model\\"+date_dir+deathVal_dir + sub_drty
